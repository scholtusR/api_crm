...
const Cliente = ({ cliente, handleEliminar }) => {
    ...
    return (
        <tr className='border-b hover:bg-gray-100'>
            ...
            <td className='p-3'>
                <button
                    className='bg-yellow-600 hover:bg-yellow-700 block w-full text-white p-2 uppercase font-bold text-xs rounded-md'
                    type='button' onClick={() => navigate(`/clientes/${id}`)}>
                    Ver
                </button>
                <button
