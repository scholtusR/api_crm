...
const Formulario = ({ cliente, cargando }) => {
    ...
    const nuevoClienteSchema = Yup.object().shape({
        ...
        telefono:
            Yup.number().typeError('El numero no es valido')
    ...
    const handleSubmit = async (valores) => {
        try {
            let respuesta
            if (cliente.id) {
                // Editando un registro cunado hay un cliente.id
                ...
                // Nuevo registro, cuando no detecta la existencia de cliente.id
                    ...
                    {({ errors, touched }) => {
                        return (
                            <Form
                                ...
                                <input
                                    type="submit"
                                    value={cliente?.nombre ? "Guardar Edición" : "Agregar Cliente"}
